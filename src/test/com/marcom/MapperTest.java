...
public class MapperTest {
	...
	public void translateAnnotationClassAClassA() throws MapperException {
		...
		TestMapClassA destinationA = new TestMapClassA( TestMapClassA.TEST_DESTINATION_A, TestMapClassA.TEST_DESTINATION_STRING );
	...
	public void translateAnnotationClassAClassB() throws MapperException {
		...
		TestMapClassA sourceA = new TestMapClassA( TestMapClassA.TEST_SOURCE_A, TestMapClassA.TEST_SOURCE_STRING );
		TestMapClassB destinationB = new TestMapClassB( TestMapClassB.TEST_DESTINATION_A, TestMapClassB.TEST_DESTINATION_STRING );
	...
	public void translateAnnotationOutMiniClass() throws MapperException {
		...
		TestMapClassA destination = new TestMapClassA( TestMapClassA.TEST_DESTINATION_A, TestMapClassA.TEST_DESTINATION_STRING );
